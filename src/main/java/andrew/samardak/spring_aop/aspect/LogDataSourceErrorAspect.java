...
public class LogDataSourceErrorAspect {
    ...
    private final LogDataSourceErrorService logDataSourceErrorService;

    private final KafkaProducerService<DataSourceErrorLog> kafkaProducerService;
    ...
    public void afterThrowing(JoinPoint joinPoint, Exception exception) {
        ...
        future.whenComplete((result, ex) -> {
            if (ex == null) {
                ...
                logDataSourceErrorService.create(message);
